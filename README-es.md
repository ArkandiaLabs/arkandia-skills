...
Donde `agent-context` *escribe* el contexto de tu repo, los skills de entrega lo *consumen* para entregar un cambio. Dale a uno el id de un ticket y corre hasta un PR en verde:
