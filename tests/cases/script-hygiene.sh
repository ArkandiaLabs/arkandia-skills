...
# everything, but after the guards were restructured to read their result from captured output
...
for n in secret-read-guard format-on-edit cpm-guard generated-files-guard; do
